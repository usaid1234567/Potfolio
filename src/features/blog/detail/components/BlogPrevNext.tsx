  ...
  return (
    <Container className="py-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {previous ? (
          <Link href={ROUTES.blogDetails(previous.slug)} className="glass-panel p-5 flex items-center gap-3 hover:border-violet/40 transition-colors">
        ...
        {next ? (
          <Link href={ROUTES.blogDetails(next.slug)} className="glass-panel p-5 flex items-center justify-end gap-3 text-right hover:border-violet/40 transition-colors">
            <div>
